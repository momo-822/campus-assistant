    ...
    <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
      ...
      <div className="p-5 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="h-3 w-12 bg-gray-200 rounded shimmer" />
        </div>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-50">
          <div className="flex items-center gap-2">
            <div className="h-3 w-14 bg-gray-200 rounded shimmer" />
            <div className="flex gap-0.5">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="h-3 w-3 bg-gray-200 rounded shimmer" />
              ))}
            </div>
          </div>
          <div className="h-3 w-8 bg-gray-200 rounded shimmer" />
        </div>
      </div>
    </div>
  )
...
function SkeletonReviewItem() {
  return (
    <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
      ...
      <div className="h-3 w-20 bg-gray-200 rounded shimmer mt-3" />
    </div>
  )
}
